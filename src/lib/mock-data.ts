...
export const mockUsers: User[] = [
  ...
  },
  {
    id: "user-4",
    name: "Taylor Wilson",
    email: "taylor.wilson@company.com",
    role: "new_hire",
...
export const mockTasks: Task[] = [
  ...
  // Plan 2 (Jordan Smith) - All tasks completed
  {
    id: "task-2-1-1",
    planId: "plan-2",
    title: "Complete company orientation session",
...
export const mockWeeklyReflections: WeeklyReflection[] = [
  // Plan 1 (Alex Chen) - Week 1 reflection
  {
    id: "reflection-1",
    planId: "plan-1",
    week: 1,
  ...
  // Plan 2 (Jordan Smith) - All 4 weeks (completed)
  {
    id: "reflection-2",
    planId: "plan-2",
    week: 1,
    unclear:
      "The CRM setup process wasn't very clear. Had to reach out to IT support for help with access.",
    takingLonger:
      "Understanding all the different tools and when to use each one. There are a lot of systems to learn!",
    mostHelpful:
      "The company overview module gave great context on our mission and values. Really helped me understand what we're building.",
    confidenceScore: 6,
  ...
  },
  {
    ...
    week: 2,
    unclear:
      "Some of the competitive positioning is still fuzzy. Would love a live session with product team to dig deeper.",
    takingLonger:
      "Learning the sales playbook and methodology. It's comprehensive but takes time to internalize.",
    mostHelpful:
      "Shadowing customer calls was eye-opening. Seeing the product in action with real customers was invaluable.",
    confidenceScore: 7,
    submittedAt: "2024-12-27T15:30:00Z",
  },
  {
    id: "reflection-4",
    planId: "plan-2",
    week: 3,
    unclear:
      "Pricing negotiations and discount approval process. When can I offer discounts and how much?",
    takingLonger:
      "Building confidence with product demos. Still nervous about technical questions from prospects.",
    mostHelpful:
      "Practice demo sessions with my buddy gave me great feedback and boosted my confidence significantly.",
    confidenceScore: 8,
    submittedAt: "2025-01-03T17:00:00Z",
  },
  {
    id: "reflection-5",
    planId: "plan-2",
    week: 4,
    unclear:
      "Nothing major at this point! Feel well-equipped to move forward independently.",
    takingLonger:
      "Everything is coming together nicely. Ready to take on my first accounts.",
    mostHelpful:
      "The 30-day check-in with my manager was fantastic. Got clear goals and feel supported going forward.",
    confidenceScore: 9,
    submittedAt: "2025-01-10T16:00:00Z",
  },
  // Plan 3 (Taylor Wilson) - Week 1 only (just started)
  {
    id: "reflection-6",
    planId: "plan-3",
    week: 1,
    unclear:
      "Everything is new! Trying to absorb as much as possible. The product suite is more complex than I expected.",
    takingLonger:
      "Getting up to speed on all the industry terminology and acronyms. Wish there was a glossary!",
    mostHelpful:
      "My onboarding buddy has been amazing. Having someone to ask 'dumb' questions to has been so helpful.",
    confidenceScore: 5,
    submittedAt: "2025-01-17T18:00:00Z",
  },
];
